...
from models.modules.funet import MiniUNet
...
class Unfolder(nn.Module):
    def __init__(self, opt_params, **kwargs):
        ...
        self.decoder_e1 = Decoder(self.num_joints, self.output_hm_shape)  # end1
        self.decoder_md = Decoder(self.num_joints, self.output_hm_shape)  # middle
        self.decoder_e2 = Decoder(self.num_joints, self.output_hm_shape)  # end2

        self.fuser = MiniUNet(2560, 2048) # fuser
    ...
    def forward(self, feat_blur_img, feat_pyramid_img, feat_blur_seg, feat_pyramid_seg):
        ...
        feat_blur_img_seg = self.fuser(feat_blur_img_seg)
        ...
        feat_e1, pred_heatmap_e1 = self.decoder_e1(feat_blur_img_seg, feat_pyramid_img)
        feat_e2, pred_heatmap_e2 = self.decoder_e2(feat_blur_img_seg, feat_pyramid_img)
        # <MODIFIED/>
